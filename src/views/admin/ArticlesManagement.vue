...
VContainer
  VRow
    ...
    VDivider
    VCol(cols="12")
      VBtn(color="green" @click="openDialog()") 新增文章
      VCol(cols="12")
      VDataTableServer(
...
//   try {
//     await apiAuth.delete('/articlesmanagement/' + item._id)
//     createSnackbar({
//       text: '刪除成功',
...
const schema = yup.object({
  ...
  category: yup
    .string()
    .required('缺少文章分類')
    .test('isCategory', '文章分類錯誤', value => categories.includes(value)),
  release: yup
    .boolean()
})
